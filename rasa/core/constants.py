...
DEFAULT_UTTERANCE_REJECTION_ENABLED_VALUE = True

DEFAULT_UTTERANCE_REJECTION_THRESHOLD = 0.7

DEFAULT_UTTERANCE_REJECTION_AMBIGUITY_THRESHOLD = 0.1

DEFAULT_UTTERANCE_REJECTION_UPON_UNEXPECTED_THRESHOLD = 0.85

DEFAULT_UTTERANCE_REJECTION_CUSTOM_THRESHOLD = {}

DEFAULT_UTTERANCE_REJECTION_METHOD = "Ignore"

DEFAULT_UTTERANCE_REJECTION_FORCE_FINAL_VALUE = True

DEFAULT_UTTERANCE_REJECTION_EXCLUDED_INTENTS = [constants.DEFAULT_NLU_FALLBACK_INTENT_NAME]
