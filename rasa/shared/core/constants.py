...
DEFAULT_INTENTS = [
    ...
    constants.DEFAULT_UTTERANCE_REJECTION_INTENT_NAME
]
...
ACTION_DEFAULT_UTTERANCE_REJECTION_NAME = "action_default_utterance_rejection"
...
POLICY_NAME_UTTERANCE_REJECTION = "UtteranceRejectionPolicy"
POLICY_NAME_FORM = "FormPolicy"
POLICY_NAME_RULE = "RulePolicy"

CLASSIFIER_NAME_FALLBACK = "FallbackClassifier"
CLASSIFIER_NAME_UTTERANCE_REJECTION = "UtteranceRejectionClassifier" # TODO: add to tests
